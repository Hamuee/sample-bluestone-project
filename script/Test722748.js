...
describe('Test722748', () => {
    it('Test722748', async function () {
        ...
        await bluestoneFunc.waitElementExists.func(frame, locator['Txt User Name'], 8161, vars.getSnapshot('Bluestone-Snapshot-1'));
        await bluestoneFunc.click.func(frame, locator['Txt User Name']);
        await bluestoneFunc.waitElementExists.func(frame, locator['Txt User Name'], 3526, vars.getSnapshot('Bluestone-Snapshot-3'));
        ...
        await bluestoneFunc.waitElementExists.func(frame, locator['Txt Password'], 3120, vars.getSnapshot('Bluestone-Snapshot-7'));
        ...
        await bluestoneFunc.waitElementExists.func(frame, locator['Opt WorkFlow'], 3023, vars.getSnapshot('Bluestone-Snapshot-11'));
        await bluestoneFunc.click.func(frame, locator['Opt WorkFlow']);
        await bluestoneFunc.waitElementExists.func(frame, locator['Lynk NewWorkflow 161'], 68610, vars.getSnapshot('Bluestone-Snapshot-13'));
